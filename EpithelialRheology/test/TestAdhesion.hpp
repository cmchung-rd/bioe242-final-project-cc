#ifndef TESTADHESION_HPP_
#define TESTADHESION_HPP_

/*
 * Cell-cell adhesion (line tension) parameter sweep — 30x4 domain
 *
 * Identical to TestControl_30x4 except lineTension (FarhadifarForce) is varied.
 * All other parameters are held at control values.
 *
 * Control value: lineTension = 0.12
 *
 * Variants (5 lower adhesion, 5 higher adhesion):
 *   0.00, 0.02, 0.04, 0.06, 0.09  <- lower line tension (less adhesion)
 *   0.18, 0.25, 0.50, 1.00, 2.00  <- higher line tension (more adhesion)
 *
 * Note: lower line tension promotes T1 neighbor exchanges (more fluid-like);
 *       higher line tension suppresses T1 swaps (more solid-like).
 *
 * Output: EpithelialRheology/Adhesion/LineTension_<value>/
 */
...
class TestAdhesion : public AbstractCellBasedTestSuite
{
private:

    /*
     * Runs the 30x4 fill simulation with a given lineTension.
     * All other parameters are fixed at control values.
     *
     * @param lineTension   FarhadifarForce cell-cell interface line tension
     * @param outputLabel   subfolder name, e.g. "LineTension_0.00"
     */
    void RunAdhesionVariant(double lineTension,
                            const std::string& outputLabel,
                            unsigned seed)
    {
        // =========================================================
        //  Parameters (all fixed at control values except lineTension)
        // =========================================================
        ...
        // FarhadifarForce (lineTension passed in; rest at control values)
        ...
        simulator.SetOutputDirectory("EpithelialRheology/Adhesion/" + outputLabel);
        ...
        std::cout << "lineTension = " << lineTension << "\n";
...
public:
    ...
    // ── 5 lower line tension variants — 3 replicates each ───────────────

    void TestLineTension_0p00_rep1() { RunAdhesionVariant(0.00, "LineTension_0.00_rep1", 1001); }
    void TestLineTension_0p00_rep2() { RunAdhesionVariant(0.00, "LineTension_0.00_rep2", 2002); }
    void TestLineTension_0p00_rep3() { RunAdhesionVariant(0.00, "LineTension_0.00_rep3", 3003); }

    void TestLineTension_0p02_rep1() { RunAdhesionVariant(0.02, "LineTension_0.02_rep1", 1001); }
    void TestLineTension_0p02_rep2() { RunAdhesionVariant(0.02, "LineTension_0.02_rep2", 2002); }
    void TestLineTension_0p02_rep3() { RunAdhesionVariant(0.02, "LineTension_0.02_rep3", 3003); }

    void TestLineTension_0p04_rep1() { RunAdhesionVariant(0.04, "LineTension_0.04_rep1", 1001); }
    void TestLineTension_0p04_rep2() { RunAdhesionVariant(0.04, "LineTension_0.04_rep2", 2002); }
    void TestLineTension_0p04_rep3() { RunAdhesionVariant(0.04, "LineTension_0.04_rep3", 3003); }

    void TestLineTension_0p06_rep1() { RunAdhesionVariant(0.06, "LineTension_0.06_rep1", 1001); }
    void TestLineTension_0p06_rep2() { RunAdhesionVariant(0.06, "LineTension_0.06_rep2", 2002); }
    void TestLineTension_0p06_rep3() { RunAdhesionVariant(0.06, "LineTension_0.06_rep3", 3003); }

    void TestLineTension_0p09_rep1() { RunAdhesionVariant(0.09, "LineTension_0.09_rep1", 1001); }
    void TestLineTension_0p09_rep2() { RunAdhesionVariant(0.09, "LineTension_0.09_rep2", 2002); }
    void TestLineTension_0p09_rep3() { RunAdhesionVariant(0.09, "LineTension_0.09_rep3", 3003); }

    // ── 5 higher line tension variants — 3 replicates each ──────────────

    void TestLineTension_0p18_rep1() { RunAdhesionVariant(0.18, "LineTension_0.18_rep1", 1001); }
    void TestLineTension_0p18_rep2() { RunAdhesionVariant(0.18, "LineTension_0.18_rep2", 2002); }
    void TestLineTension_0p18_rep3() { RunAdhesionVariant(0.18, "LineTension_0.18_rep3", 3003); }

    void TestLineTension_0p25_rep1() { RunAdhesionVariant(0.25, "LineTension_0.25_rep1", 1001); }
    void TestLineTension_0p25_rep2() { RunAdhesionVariant(0.25, "LineTension_0.25_rep2", 2002); }
    void TestLineTension_0p25_rep3() { RunAdhesionVariant(0.25, "LineTension_0.25_rep3", 3003); }

    void TestLineTension_0p50_rep1() { RunAdhesionVariant(0.50, "LineTension_0.50_rep1", 1001); }
    void TestLineTension_0p50_rep2() { RunAdhesionVariant(0.50, "LineTension_0.50_rep2", 2002); }
    void TestLineTension_0p50_rep3() { RunAdhesionVariant(0.50, "LineTension_0.50_rep3", 3003); }

    void TestLineTension_1p00_rep1() { RunAdhesionVariant(1.00, "LineTension_1.00_rep1", 1001); }
    void TestLineTension_1p00_rep2() { RunAdhesionVariant(1.00, "LineTension_1.00_rep2", 2002); }
    void TestLineTension_1p00_rep3() { RunAdhesionVariant(1.00, "LineTension_1.00_rep3", 3003); }

    void TestLineTension_2p00_rep1() { RunAdhesionVariant(2.00, "LineTension_2.00_rep1", 1001); }
    void TestLineTension_2p00_rep2() { RunAdhesionVariant(2.00, "LineTension_2.00_rep2", 2002); }
    void TestLineTension_2p00_rep3() { RunAdhesionVariant(2.00, "LineTension_2.00_rep3", 3003); }
};

#endif // TESTADHESION_HPP_
